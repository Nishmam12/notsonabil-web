...
export default function ReviewHighlight() {
  return (
    <section className="container mx-auto w-full px-6 py-12 sm:px-8 sm:py-16 lg:px-10 lg:py-20">
      <div className="relative rounded-[28px] border border-neutral-200 bg-white px-6 py-8 text-center shadow-[0_30px_70px_rgba(0,0,0,0.08)] dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-[0_30px_70px_rgba(0,0,0,0.4)] sm:px-8 sm:py-10">
        ...
        <div className="mt-10 text-xs font-semibold uppercase tracking-[0.3em] text-neutral-400 dark:text-neutral-500">
          i have worked with
        </div>
        <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm font-semibold text-neutral-400 dark:text-neutral-500">
          <span>BLUSSYTLE</span>
          <span>MECHLANDS</span>
